...
def create_database(filename):
    ...
    with open("Labs/USAStatesCO2.csv") as file:
        lines = file.readlines(encoding='latin-1')
        
        with open('emissions.csv', 'r', encoding='latin-1') as file:
    lines = []
    for line in file:
    ...
    for i, line in enumerate(lines[3:]):
        ...
        cursor.execute(f"INSERT INTO emissions VALUES ('{state}', " +
                       ", ".join([str(emission) if emission is not None else 'NULL'
