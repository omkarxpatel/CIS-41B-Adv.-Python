...
soup = BeautifulSoup(requests.get('https://en.wikipedia.org/wiki/List_of_countries_by_carbon_dioxide_emissions_per_capita').content, 'html.parser')soup.find('table', {'class': 'wikitable sortable'})
ultdict(dict)
