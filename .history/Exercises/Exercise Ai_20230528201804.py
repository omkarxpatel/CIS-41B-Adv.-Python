...
class Encryption:
    ...
    def ReadFrequency(self, filename):
        ...
        #print(list(zip(charList, freqList)))
        #print(freqPD)
    ...
    # Encrypt algorithm from Exercise AI
...
myEncrypt.ReadFrequency("Frequencies.txt")

# Iterate through file with rotations 1 thru 7
for i in range(1,8):
    myEncrypt.FileDecrypt("Encrypted.bin", i)