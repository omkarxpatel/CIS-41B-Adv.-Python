...
class Server:
    def __init__(self, database_name):
        ...
        self.users = {1:{"name":"michael", "age":15, "orders":["apple", "carrot"]}, 2:{"name":"ryan", "age": 17, "orders":["vbucks","ps5"]}, 3:{"name":"william", "age": 21, "order":["milk", "bread"]}}
