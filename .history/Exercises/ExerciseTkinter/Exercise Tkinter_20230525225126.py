...
# button = tk.Button(window, text="Generate Playlist", command=main, font=("Arial", 12), bg="#4CAF50", fg="white", relief=tk.RAISED)
# button.pack(pady=20)
button = tk.Button(window, text="Generate Playlist", command=main, font=("Arial", 12))
button.pack(pady=20)

error = tk.Label(window, text="Enter Playlist Link", font=("Arial", 30))
label.pack(pady=10)
