...
class Server:
    def __init__(self, database_name):
        ...
        self.users = {1:{"name":"michael", "age":15}, 2:{"name":"ryan", "age": 17}, 3:{"name":"william", "age": 21}}
    ...
    def __call__(self, sql_query):
       ...
       def process_query(self, sql_query):
        ...
        elif sql_query.startswith("SELECT * FROM users WHERE id = "):
            user_id = int(sql_query.split("=")[1].strip())
