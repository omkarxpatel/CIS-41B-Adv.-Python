...
title = soup.find(id="<span class="mw-headline" id="Production-based_emissions:_annual_carbon_dioxide_emissions_in_metric_tons_per_capita">Production-based emissions: annual carbon dioxide emissions in metric tons per capita</span>")
