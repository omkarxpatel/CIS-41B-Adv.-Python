...
def QueryBuilder( Data_Base, Query_Type, Query_Tuple):
    ...
    if Query_Type == 'version':
        ...
        q = 'INSERT INTO {Data_Base} (id, name, photo, html) VALUES ({Query_Tuple[0]}, {Query_Tuple[1]}, {Query_Tuple[2]}, {Query_Tuple[3]})'.format(Data_Base, Query_Tuple[0], Query_Tuple[1], Query_Tuple[2], Query_Tuple[3])
