...
def main():
    ...
    data = [
        GreenhouseGasData("Carbon dioxide", int(gas_list[0][1]), str(gas_list[0][2]), str(gas_list[0][3]), int(gas_list[0][4])),
        GreenhouseGasData("Methane", int(gas_list[1][1]), str(gas_list[1][2]), str(gas_list[1][3]), int(gas_list[1][4])),
        GreenhouseGasData("Nitrous oxide", int(gas_list[2][1]), int(gas_list[2][2]), str(gas_list[2][3]), int(gas_list[2][4])),
        GreenhouseGasData("Fluorinated gases", int(gas_list[3][1]), int(gas_list[3][2]), str(gas_list[3][3]), int(gas_list[3][4])),
    ]
