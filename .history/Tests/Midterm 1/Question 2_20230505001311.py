...
for row in rows[1:]:
    ...
    cols = [re.findall(r'\b(?:Carbon dioxide|Methane|Nitrous oxide|Tropospheric ozone)\b', col)[0] if any(word in col for word in ['Carbon dioxide', 'Methane', 'Nitrous oxide', 'Tropospheric ozone']) else col.split(' (', 1)[0] for col in cols]  # extract gas names
