...
def main():
    ...
    data = [
        ...
        GreenhouseGasData("Methane", int(gas_list[0][1]), int(gas_list[0][2]), int(gas_list[0][3]), int(gas_list[0][4])),
        GreenhouseGasData("Nitrous oxide", int(gas_list[0][1]), int(gas_list[0][2]), int(gas_list[0][3]), int(gas_list[0][4])),
