...
def main():
    ...
    data = [
        ...
        GreenhouseGasData(str(gas_list[1][2]), int(gas_list[1][1]), str(gas_list[1][2]), str(gas_list[1][3]), str(gas_list[1][4])),
        GreenhouseGasData(str(gas_list[2][2]), int(gas_list[2][1]), str(gas_list[2][2]), str(gas_list[2][3]), str(gas_list[2][4])),
        GreenhouseGasData(str(gas_list[01][]), int(gas_list[3][1]), str(gas_list[3][2]), str(gas_list[3][3]), str(gas_list[3][4])),
    ]
    print()
