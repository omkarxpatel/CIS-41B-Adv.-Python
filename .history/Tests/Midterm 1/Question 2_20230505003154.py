...
def main():
    ...
    data = [
        ...
        GreenhouseGasData("Nitrous oxide", int(gas_list[2][1]), str(gas_list[2][2]), str(gas_list[2][3]), int(gas_list[2][4])),
        GreenhouseGasData("Fluorinated gases", int(gas_list[3][1]), str(gas_list[3][2]), str(gas_list[3][3]), int(gas_list[3][4])),
    ]
