...
class Encryption:
    ...
    def __str__(self) -> str:
        return f"Encryption instance with most frequent word: {self._mostFreqWord}"

    def __repr__(self) -> str:
        return f"Encryption()"

    def Decrypt(self, byte: int, amount: int) -> int:
        mask = 2 ** amount - 1
    ...
    def FileDecrypt(self, filename: str, amount: int, chunk_size: int = 1024) -> None:
    ...
    def ReadFrequency(self, filename: str) -> None:
        ...
        print(25 * '*')
        print("Max Word - Exercises/ExerciseAI/Frequencies.txt:", self._mostFreqWord, bin(self._mostFreqWord),
              "'" + chr(self._mostFreqWord) + "'")

    def Encrypt(self, byte: int, amount: int) -> int:
        mask = 2 ** amount - 1
        print("Mask", mask)
...
myEncrypt.ReadFrequency("Exercises/ExerciseAI/Frequencies.txt") # my path to the txt file
for i in range(1, 8):
